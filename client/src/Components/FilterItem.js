...
const StudyItem = ({ filterType }) => {
  ...
  const handleReplayAudio = () => {
    ...
    if (audioElement) {
      ...
      let audioSourceUrl;
      const filterURL = `${URL}/assets/test_sentence/filter`;
      if (filterType == "A") {
        audioSourceUrl = filterURL + filterType + "-test/stereo_ISTS.wav";
      } else if (filterType == "B") {
        audioSourceUrl = filterURL + filterType + "-test/stereo_Pink_Noise.wav";
      } else if (filterType == "C") {
        audioSourceUrl = filterURL + filterType + "-test/stereo_Pink_Noise.wav";
      } else {
        audioSourceUrl = filterURL + filterType + "-test/stereo_ISTS.wav";
      ...
      <form onSubmit={handleSubmit} className={styles.formLayout}>
        ...
        <div className={styles.inlineGroup}>
          ...
          <audio ref={audioRef}>
            {filterType === "A" ? (
              <source
                src={`${URL}/assets/test_sentence/filter${filterType}-test/stereo_ISTS.wav`}
                type="audio/wav"
              />
            ) : filterType === "B" ? (
              <source
                src={`${URL}/assets/test_sentence/filter${filterType}-test/stereo_Pink_Noise.wav`}
                type="audio/wav"
              />
            ) : filterType === "C" ? (
              <source
